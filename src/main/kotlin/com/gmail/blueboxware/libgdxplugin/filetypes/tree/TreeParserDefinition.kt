...
internal class TreeParserDefinition : ParserDefinition {
    ...
    override fun createLexer(project: Project?): Lexer = TreeLexerAdapter()

    override fun createParser(project: Project?): PsiParser = TreeParser()
    ...
    override fun createFile(viewProvider: FileViewProvider): PsiFile = TreeFile(viewProvider)
}
