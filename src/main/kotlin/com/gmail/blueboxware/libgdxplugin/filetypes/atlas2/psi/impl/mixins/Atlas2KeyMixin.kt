...
import com.gmail.blueboxware.libgdxplugin.filetypes.atlas2.psi.Atlas2Key
 ...
 */
abstract class Atlas2KeyMixin(node: ASTNode) : Atlas2Key, Atlas2ElementImpl(node) {

    override fun getValue() = text.trim()
