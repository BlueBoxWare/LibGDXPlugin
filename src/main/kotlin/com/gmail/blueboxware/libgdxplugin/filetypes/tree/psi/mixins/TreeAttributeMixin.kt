...
abstract class TreeAttributeMixin(node: ASTNode) : PsiTreeAttribute, TreeElementImpl(node) {

    override fun getNameIdentifier(): PsiElement = attributeName

    override fun getName(): String? = attributeName.name
