 ...
 */
class SkinTagsFileListener(val project: Project) : BulkFileListener {

    override fun after(events: MutableList<out VFileEvent>) {
        if (events.any { it.file?.fileType == JavaFileType.INSTANCE || it.file?.fileType == KotlinFileType.INSTANCE }) {
