 ...
 * limitations under the License.
 */
internal class GdxUseScopeEnlarger : UseScopeEnlarger() {

    override fun getAdditionalUseScope(element: PsiElement): SearchScope? {

        if (element !is PsiClass && element !is KtClass && element !is PsiField) return null
        ...
        return GlobalSearchScope.getScopeRestrictedByFileTypes(
            element.project.projectScope(), LibGDXSkinFileType,
            TreeFileType
        )
