...
import com.gmail.blueboxware.libgdxplugin.filetypes.bitmapFont.psi.impl.mixins.BitmapFontFontCharMixin;
import com.gmail.blueboxware.libgdxplugin.filetypes.bitmapFont.psi.*;

public class BitmapFontFontCharImpl extends BitmapFontFontCharMixin implements BitmapFontFontChar {

  public BitmapFontFontCharImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BitmapFontElementVisitor visitor) {
    visitor.visitFontChar(this);
  }
