...
import com.gmail.blueboxware.libgdxplugin.filetypes.bitmapFont.psi.impl.mixins.BitmapFontCommonMixin;
import com.gmail.blueboxware.libgdxplugin.filetypes.bitmapFont.psi.*;

public class BitmapFontCommonImpl extends BitmapFontCommonMixin implements BitmapFontCommon {

  public BitmapFontCommonImpl(@NotNull ASTNode node) {
    super(node);
  }
