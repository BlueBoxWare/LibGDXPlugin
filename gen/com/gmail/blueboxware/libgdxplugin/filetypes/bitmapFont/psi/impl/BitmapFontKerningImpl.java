...
import com.gmail.blueboxware.libgdxplugin.filetypes.bitmapFont.psi.impl.mixins.BitmapFontKerningMixin;
import com.gmail.blueboxware.libgdxplugin.filetypes.bitmapFont.psi.*;

public class BitmapFontKerningImpl extends BitmapFontKerningMixin implements BitmapFontKerning {

  public BitmapFontKerningImpl(@NotNull ASTNode node) {
    super(node);
  }
