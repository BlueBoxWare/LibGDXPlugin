...
import com.gmail.blueboxware.libgdxplugin.filetypes.tree.psi.mixins.TreeIndentMixin;
import com.gmail.blueboxware.libgdxplugin.filetypes.tree.psi.*;

public class PsiTreeIndentImpl extends TreeIndentMixin implements PsiTreeIndent {

  public PsiTreeIndentImpl(ASTNode node) {
    super(node);
  }
