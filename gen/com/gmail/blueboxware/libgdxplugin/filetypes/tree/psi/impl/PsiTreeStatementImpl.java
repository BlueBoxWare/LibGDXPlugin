...
import com.gmail.blueboxware.libgdxplugin.filetypes.tree.psi.mixins.TreeStatementMixin;
import com.gmail.blueboxware.libgdxplugin.filetypes.tree.psi.*;

public class PsiTreeStatementImpl extends TreeStatementMixin implements PsiTreeStatement {

  public PsiTreeStatementImpl(ASTNode node) {
    super(node);
  }
